...
/// Весь этот класс преобразует широту и долготу в читаемую ось в Unity.
/// Широта и долгота представлены на круглом глобусе. Мы хотим взять его и поместить на ровную поверхность.
