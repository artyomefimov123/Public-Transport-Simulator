...
/// Ётот класс управл€ет движением камеры. ѕользователь может управл€ть направлением просмотра с помощью
/// мышь и перемещение с помощью клавиш WASD. ѕользователь также может нажать на станции и активировать их.
